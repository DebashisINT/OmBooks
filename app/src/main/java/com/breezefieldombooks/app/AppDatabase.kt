package com.breezefieldombooks.app
...
import com.breezefieldombooks.LoanDispositionDao
import com.breezefieldombooks.LoanDispositionEntity

import com.breezefieldombooks.app.AppConstant.DBNAME
import com.breezefieldombooks.app.domain.*
import com.breezefieldombooks.features.lead.model.LeadActivityDao
import com.breezefieldombooks.features.lead.model.LeadActivityEntity
import com.breezefieldombooks.features.location.UserLocationDataDao
import com.breezefieldombooks.features.location.UserLocationDataEntity
import com.breezefieldombooks.features.login.*
import com.breezefieldombooks.features.taskManagement.model.TaskManagementDao
...
@Database(entities = arrayOf(AddShopDBModelEntity::class, UserLocationDataEntity::class, UserLoginDataEntity::class, ShopActivityEntity::class,
    ...
    NewProductListEntity::class, NewRateListEntity::class, NewOrderDataEntity::class,NewOrderProductDataEntity::class,OpportunityStatusEntity::class,OpportunityAddEntity::class,OpportunityProductEntity::class,LmsUserInfoEntity::class,LoanRiskTypeEntity::class,LoanDispositionEntity::class,LoanFinalStatusEntity::class,LoanDetailFetchEntity::class,
    ShopAudioEntity::class,LMSNotiEntity::class,StockAllEntity::class,StockTransEntity::class,CrashReportEntity::class,ShopExtraDtlsEntity::class),
