package com.breezefieldombooks.features.commondialogsinglebtn
...
import com.breezefieldombooks.app.domain.ShopVisitCompetetorModelEntity
import com.breezefieldombooks.app.domain.VisitRemarksEntity
...
import com.breezefieldombooks.features.addshop.presentation.ProspectListDialog
import com.breezefieldombooks.features.dashboard.presentation.DashboardActivity
import com.breezefieldombooks.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezefieldombooks.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezefieldombooks/files", "recorded_audio${System.currentTimeMillis()}.mp3")
