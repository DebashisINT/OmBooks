...
import com.breezefieldombooks.*
import com.breezefieldombooks.R
import com.breezefieldombooks.app.*
import com.breezefieldombooks.app.NewFileUtils.browseDocuments
import com.breezefieldombooks.app.NewFileUtils.browsePDFDocuments
import com.breezefieldombooks.app.NewFileUtils.getExtension
import com.breezefieldombooks.app.domain.*
import com.breezefieldombooks.app.types.DashboardType
import com.breezefieldombooks.app.types.FragType
import com.breezefieldombooks.app.types.TopBarConfig
import com.breezefieldombooks.app.uiaction.DisplayAlert
import com.breezefieldombooks.app.utils.*
import com.breezefieldombooks.app.utils.AppUtils.Companion.isProfile
...
import com.breezefieldombooks.features.NewQuotation.*
import com.breezefieldombooks.features.NewQuotation.api.GetQuotRegProvider
import com.breezefieldombooks.features.NewQuotation.model.ViewDetailsQuotResponse
import com.breezefieldombooks.features.SearchLocation.SearchLocationFragment
import com.breezefieldombooks.features.SearchLocation.locationInfoModel
import com.breezefieldombooks.features.TA.ViewAllTAListFragment
import com.breezefieldombooks.features.achievement.AchievementFragment
import com.breezefieldombooks.features.activities.presentation.*
import com.breezefieldombooks.features.addAttendence.*
import com.breezefieldombooks.features.addAttendence.api.addattendenceapi.AddAttendenceRepoProvider
import com.breezefieldombooks.features.addAttendence.api.leavetytpeapi.LeaveTypeRepoProvider
import com.breezefieldombooks.features.addAttendence.model.GetReportToFCMResponse
import com.breezefieldombooks.features.addAttendence.model.GetReportToResponse
import com.breezefieldombooks.features.addAttendence.model.Leave_list_Response
import com.breezefieldombooks.features.addorder.presentation.AddOrderFragment
...
import com.breezefieldombooks.features.addshop.presentation.AddShopFragment
import com.breezefieldombooks.features.addshop.presentation.OTPVerificationDialog
import com.breezefieldombooks.features.addshop.presentation.ScanImageFragment
import com.breezefieldombooks.features.addshop.presentation.ShowCardDetailsDialog
import com.breezefieldombooks.features.alarm.model.AlarmData
import com.breezefieldombooks.features.alarm.presetation.AttendanceReportFragment
import com.breezefieldombooks.features.alarm.presetation.PerformanceReportFragment
import com.breezefieldombooks.features.alarm.presetation.VisitReportDetailsFragment
import com.breezefieldombooks.features.alarm.presetation.VisitReportFragment
import com.breezefieldombooks.features.attendance.AttendanceFragment
import com.breezefieldombooks.features.attendance.api.AttendanceRepositoryProvider
import com.breezefieldombooks.features.attendance.model.AttendanceRequest
import com.breezefieldombooks.features.attendance.model.AttendanceResponse
import com.breezefieldombooks.features.averageshop.presentation.AverageShopFragment
import com.breezefieldombooks.features.avgorder.presentation.AverageOrderFragment
import com.breezefieldombooks.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.breezefieldombooks.features.beatCustom.TeamBeatListFragment
import com.breezefieldombooks.features.billing.presentation.AddBillingFragment
import com.breezefieldombooks.features.billing.presentation.BillingDetailsFragment
import com.breezefieldombooks.features.billing.presentation.BillingListFragment
import com.breezefieldombooks.features.changepassword.presentation.ChangePasswordDialog
import com.breezefieldombooks.features.chat.model.ChatListDataModel
import com.breezefieldombooks.features.chat.model.ChatUserDataModel
import com.breezefieldombooks.features.chat.model.GroupUserDataModel
import com.breezefieldombooks.features.chat.presentation.*
import com.breezefieldombooks.features.chatbot.presentation.ChatBotFragment
import com.breezefieldombooks.features.chatbot.presentation.ChatBotShopListFragment
import com.breezefieldombooks.features.chatbot.presentation.ReportsFragment
import com.breezefieldombooks.features.chatbot.presentation.SelectLanguageDialog
import com.breezefieldombooks.features.commondialog.presentation.CommonDialog
import com.breezefieldombooks.features.commondialog.presentation.CommonDialogClickListener
import com.breezefieldombooks.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.breezefieldombooks.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.breezefieldombooks.features.commondialogsinglebtn.OnDialogClickListener
import com.breezefieldombooks.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.breezefieldombooks.features.contacts.ActivityDtlsFrag
import com.breezefieldombooks.features.contacts.AddOpptFrag
import com.breezefieldombooks.features.contacts.ContactDtls
import com.breezefieldombooks.features.contacts.ContactGr
import com.breezefieldombooks.features.contacts.ContactsAddFrag
import com.breezefieldombooks.features.contacts.ContactsFrag
import com.breezefieldombooks.features.contacts.SchedulerAddFormFrag
import com.breezefieldombooks.features.contacts.SchedulerViewFrag
import com.breezefieldombooks.features.contacts.TemplateAddFrag
import com.breezefieldombooks.features.contacts.TemplateViewFrag
import com.breezefieldombooks.features.contacts.ViewCrmOpptFrag
import com.breezefieldombooks.features.dailyPlan.prsentation.AllShopListFragment
import com.breezefieldombooks.features.dailyPlan.prsentation.DailyPlanListFragment
import com.breezefieldombooks.features.dailyPlan.prsentation.PlanDetailsFragment
import com.breezefieldombooks.features.damageProduct.ShopDamageProductListFrag
import com.breezefieldombooks.features.damageProduct.ShopDamageProductSubmitFrag
import com.breezefieldombooks.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.breezefieldombooks.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.breezefieldombooks.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.breezefieldombooks.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.breezefieldombooks.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.breezefieldombooks.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.breezefieldombooks.features.dashboard.presentation.model.ContentListResponseModel
import com.breezefieldombooks.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.breezefieldombooks.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.breezefieldombooks.features.device_info.presentation.DeviceInfoListFragment
import com.breezefieldombooks.features.distributorwiseorder.DistributorwiseorderlistFragment
import com.breezefieldombooks.features.document.DocumentRepoFeatureNewFragment
import com.breezefieldombooks.features.document.presentation.DocumentListFragment
import com.breezefieldombooks.features.document.presentation.DocumentTypeListFragment
import com.breezefieldombooks.features.document.presentation.OpenFileWebViewFragment
import com.breezefieldombooks.features.dymanicSection.presentation.AddDynamicFragment
import com.breezefieldombooks.features.dymanicSection.presentation.AllDynamicListFragment
import com.breezefieldombooks.features.dymanicSection.presentation.DynamicListFragment
import com.breezefieldombooks.features.dymanicSection.presentation.EditDynamicFragment
import com.breezefieldombooks.features.gpsDisabilityScreen.GpsDisableFragment
import com.breezefieldombooks.features.home.presentation.HomeFragment
import com.breezefieldombooks.features.homelocation.presentation.HomeLocationFragment
import com.breezefieldombooks.features.homelocation.presentation.HomeLocationMapFragment
import com.breezefieldombooks.features.know_your_state.KnowYourStateFragment
import com.breezefieldombooks.features.lead.LeadFrag
import com.breezefieldombooks.features.lead.ViewLeadFrag
import com.breezefieldombooks.features.leaderboard.LeaderBoardFrag
import com.breezefieldombooks.features.leaveapplynew.LeaveHome
import com.breezefieldombooks.features.leaveapplynew.model.clearAttendanceonRejectReqModelRejectReqModel
import com.breezefieldombooks.features.localshops.LocalShopListFragment
import com.breezefieldombooks.features.localshops.LocalShopListMapFragment
import com.breezefieldombooks.features.localshops.NearByShopsMapFragment
import com.breezefieldombooks.features.location.*
import com.breezefieldombooks.features.location.api.LocationRepoProvider
import com.breezefieldombooks.features.location.model.*
import com.breezefieldombooks.features.location.shopRevisitStatus.ShopRevisitStatusRepositoryProvider
import com.breezefieldombooks.features.location.shopdurationapi.ShopDurationRepositoryProvider
import com.breezefieldombooks.features.login.ShopFeedbackEntity
import com.breezefieldombooks.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.breezefieldombooks.features.login.presentation.LoginActivity
import com.breezefieldombooks.features.logout.presentation.api.LogoutRepositoryProvider
import com.breezefieldombooks.features.logoutsync.presentation.LogoutSyncFragment
import com.breezefieldombooks.features.marketAssist.MarketAssistTabFrag
import com.breezefieldombooks.features.marketAssist.ShopDtlsMarketAssistFrag
import com.breezefieldombooks.features.marketAssist.ShopListMarketAssistFrag
import com.breezefieldombooks.features.marketing.presentation.MarketingPagerFragment
import com.breezefieldombooks.features.meetinglist.prsentation.MeetingListFragment
import com.breezefieldombooks.features.member.MapViewForTeamFrag
import com.breezefieldombooks.features.member.model.TeamLocDataModel
import com.breezefieldombooks.features.member.model.TeamShopListDataModel
import com.breezefieldombooks.features.member.presentation.*
import com.breezefieldombooks.features.menuBeat.MenuBeatFrag
import com.breezefieldombooks.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.breezefieldombooks.features.micro_learning.presentation.MicroLearningListFragment
import com.breezefieldombooks.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.breezefieldombooks.features.myallowancerequest.MyallowanceRequestFragment
import com.breezefieldombooks.features.myjobs.model.CustomerDataModel
import com.breezefieldombooks.features.myjobs.presentation.*
import com.breezefieldombooks.features.mylearning.MyLearningFragment
import com.breezefieldombooks.features.myorder.presentation.MyOrderListFragment
import com.breezefieldombooks.features.myprofile.presentation.MyProfileFragment
...
import com.breezefieldombooks.features.nearbyshops.model.ShopListResponse
import com.breezefieldombooks.features.nearbyshops.multipleattachImage.MultipleImageFragment
import com.breezefieldombooks.features.nearbyshops.presentation.BeatListFragment
import com.breezefieldombooks.features.nearbyshops.presentation.NearByShopsListFragment
import com.breezefieldombooks.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.breezefieldombooks.features.nearbyshops.presentation.ShopCallHisFrag
import com.breezefieldombooks.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.breezefieldombooks.features.newcollection.CollectionDetailsStatusFragment
import com.breezefieldombooks.features.newcollection.CollectionShopListFragment
import com.breezefieldombooks.features.newcollection.NewCollectionListFragment
import com.breezefieldombooks.features.newcollectionreport.*
import com.breezefieldombooks.features.notification.NotificationFragment
import com.breezefieldombooks.features.orderITC.CartListFrag
import com.breezefieldombooks.features.orderITC.OrderListFrag
import com.breezefieldombooks.features.orderITC.ProductListFrag
import com.breezefieldombooks.features.orderITC.ViewNewOrdHisAllFrag
import com.breezefieldombooks.features.orderITC.ViewNewOrdHistoryFrag
import com.breezefieldombooks.features.orderITC.ViewOrdDtls
import com.breezefieldombooks.features.orderList.NewDateWiseOrderListFragment
import com.breezefieldombooks.features.orderList.NewOrderListFragment
import com.breezefieldombooks.features.orderList.OrderListFragment
import com.breezefieldombooks.features.orderdetail.presentation.OrderDetailFragment
import com.breezefieldombooks.features.orderhistory.ActivityMapFragment
import com.breezefieldombooks.features.orderhistory.OrderhistoryFragment
import com.breezefieldombooks.features.orderhistory.TimeLineFragment
import com.breezefieldombooks.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
...
import com.breezefieldombooks.features.orderhistory.model.LocationData
import com.breezefieldombooks.features.pendinglocationinout.PendingOutLocationFrag
import com.breezefieldombooks.features.performance.GpsStatusFragment
import com.breezefieldombooks.features.performance.PerformanceFragment
import com.breezefieldombooks.features.performance.api.UpdateGpsStatusRepoProvider
import com.breezefieldombooks.features.performance.model.UpdateGpsInputParamsModel
import com.breezefieldombooks.features.performanceAPP.OwnPerformanceFragment
import com.breezefieldombooks.features.performanceAPP.PerformanceAppFragment
import com.breezefieldombooks.features.performanceAPP.allPerformanceFrag
import com.breezefieldombooks.features.permissionList.ViewPermissionFragment
import com.breezefieldombooks.features.photoReg.*
import com.breezefieldombooks.features.privacypolicy.PrivacypolicyWebviewFrag
import com.breezefieldombooks.features.quotation.presentation.*
import com.breezefieldombooks.features.reimbursement.presentation.*
import com.breezefieldombooks.features.report.presentation.*
import com.breezefieldombooks.features.returnsOrder.*
import com.breezefieldombooks.features.settings.presentation.SettingsFragment
import com.breezefieldombooks.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.breezefieldombooks.features.shopdetail.presentation.*
import com.breezefieldombooks.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldombooks.features.stock.StockDetailsFragment
import com.breezefieldombooks.features.stock.StockListFragment
import com.breezefieldombooks.features.stockAddCurrentStock.AddShopStockFragment
import com.breezefieldombooks.features.stockAddCurrentStock.UpdateShopStockFragment
import com.breezefieldombooks.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.breezefieldombooks.features.stockAddCurrentStock.model.MultipleImageFileUploadonStock
import com.breezefieldombooks.features.stockCompetetorStock.AddCompetetorStockFragment
import com.breezefieldombooks.features.stockCompetetorStock.CompetetorStockFragment
import com.breezefieldombooks.features.stockCompetetorStock.ViewComStockProductDetails
import com.breezefieldombooks.features.survey.SurveyFrag
import com.breezefieldombooks.features.survey.SurveyViewDtlsFrag
import com.breezefieldombooks.features.survey.SurveyViewFrag
import com.breezefieldombooks.features.task.presentation.AddTaskFragment
import com.breezefieldombooks.features.task.presentation.CalenderTaskFragment
import com.breezefieldombooks.features.task.presentation.EditTaskFragment
import com.breezefieldombooks.features.task.presentation.TaskListFragment
import com.breezefieldombooks.features.taskManagement.TaskManagementFrag
import com.breezefieldombooks.features.taskManagement.ViewTaskManagementFrag
import com.breezefieldombooks.features.timesheet.presentation.AddTimeSheetFragment
import com.breezefieldombooks.features.timesheet.presentation.EditTimeSheetFragment
import com.breezefieldombooks.features.timesheet.presentation.TimeSheetListFragment
import com.breezefieldombooks.features.viewAllOrder.CartFragment
import com.breezefieldombooks.features.viewAllOrder.OrderTypeListFragment
import com.breezefieldombooks.features.viewAllOrder.ViewAllOrderListFragment
import com.breezefieldombooks.features.viewAllOrder.ViewCartFragment
import com.breezefieldombooks.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.breezefieldombooks.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.breezefieldombooks.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.breezefieldombooks.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.breezefieldombooks.features.viewAllOrder.orderOptimized.OrderProductCartFrag
import com.breezefieldombooks.features.viewAllOrder.orderOptimized.OrderProductListFrag
import com.breezefieldombooks.features.viewPPDDStock.ViewOutstandingFragment
import com.breezefieldombooks.features.viewPPDDStock.ViewPPDDListFragment
import com.breezefieldombooks.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.breezefieldombooks.features.viewPPDDStock.ViewStockFragment
import com.breezefieldombooks.features.weather.presentation.WeatherFragment
import com.breezefieldombooks.mappackage.MapActivity
import com.breezefieldombooks.mappackage.MapActivityWithoutPath
import com.breezefieldombooks.mappackage.SendBrod
import com.breezefieldombooks.widgets.AppCustomEditText
import com.breezefieldombooks.widgets.AppCustomTextView
...
import com.breezefieldombooks.features.mylearning.AllTopicsWiseContents
...
import com.breezefieldombooks.features.mylearning.MyLearningAllVideoList
import com.breezefieldombooks.features.mylearning.MyLearningTopicList
...
// val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xbreezefieldombookslogsample/log").path);
            //27-09-2021
// val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldombookslogsample/log").path);
...
// BuildConfig.APPLICATION_ID+"/Log/Fsmlog.html").path);
            var currentDBPath = "/data/user/0/com.breezefieldombooks/files/Fsmlog.html"
        ...
        try {
            ...
            val fileUrl1 = Uri.parse(
                File(
                    ...
                    "xbreezefieldombookslogsample/log"
                ).path
            );
            val fileUrl2 = Uri.parse(
                File(
                    Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xbreezefieldombookslogsample/log.bak.1"
                ).path
            );
...
// return super.onCreateOptionsMenu(menu)
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root = File(
                Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                "xbreezefieldombookslogsample/log" + ".txt"
            )
            if (!root.exists()) {
                root.mkdirs()
            }
