...
import com.breezefieldombooks.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezefieldombooks.app.utils.FTStorageUtils
import com.breezefieldombooks.app.utils.NotificationUtils
...
import com.breezefieldombooks.features.addshop.model.QuestionSubmit
import com.breezefieldombooks.features.addshop.model.UpdateAddrReq
import com.breezefieldombooks.features.addshop.model.UpdateAddressShop
...
import com.breezefieldombooks.features.addshop.presentation.*
...
import com.breezefieldombooks.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezefieldombooks.features.marketing.model.MarketingCategoryListResponse
...
import com.breezefieldombooks.features.nearbyshops.model.StageListResponseModel
...
import com.breezefieldombooks.features.viewAllOrder.interf.QaOnCLick
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezefieldombooksApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
