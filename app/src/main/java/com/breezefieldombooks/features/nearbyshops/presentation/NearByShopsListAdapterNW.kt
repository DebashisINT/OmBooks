...
import com.breezefieldombooks.features.nearbyshops.model.NewOrderModel
...
class NearByShopsListAdapterNW(context: Context, list: List<AddShopDBModelEntity>, val listener: NearByShopsListClickListener) : RecyclerView.Adapter<NearByShopsListAdapterNW.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val v = layoutInflater.inflate(R.layout.row_shop_nw, parent, false)
        return MyViewHolder(v)
    }

    override fun onBindViewHolder(holder: NearByShopsListAdapterNW.MyViewHolder, position: Int) {
    ...
    class MyViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindItems(context: Context, list: List<AddShopDBModelEntity>, listener: NearByShopsListClickListener) {
            ...
            try {
                ...
                itemView.shop_image_IV.findViewById<ImageView>(R.id.shop_image_IV).setOnClickListener(
                ...
                itemView.direction_ll.findViewById<LinearLayout>(R.id.direction_ll).setOnClickListener(
                    View.OnClickListener {
                ...
                itemView.update_address_TV.findViewById<AppCustomTextView>(R.id.update_address_TV).setOnClickListener(
                    View.OnClickListener {
                ...
                val lastVisitAge = AppUtils.getDayFromSubtractDates(
                    AppUtils.getLongTimeStampFromDate2(list[adapterPosition].lastVisitedDate),
