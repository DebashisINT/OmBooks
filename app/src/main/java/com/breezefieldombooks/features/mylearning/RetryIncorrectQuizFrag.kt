...
class RetryIncorrectQuizFrag : BaseFragment() , View.OnClickListener {
    ...
    private fun initView(view: View) {
        ...
        retryTabPagerAdapter = RetryTabPagerAdapter(fragmentManager , topic_id , store_content_id)
        tv_correct_tab.setOnClickListener(this)
        tv_incorrect_tab.setOnClickListener(this)
        tab_viewpager.currentItem = 0
        isCorrect(true)
        tv_correct_tab.setBackgroundColor(Color.parseColor("#289725"))
    ...
    fun isCorrect(isCorrect: Boolean) {
        if (isCorrect) {
            ...
            tv_incorrect_tab  .setBackgroundColor(Color.parseColor("#8313B1"))
