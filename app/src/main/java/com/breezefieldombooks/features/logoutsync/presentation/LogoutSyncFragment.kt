package com.breezefieldombooks.features.logoutsync.presentation
...
import com.breezefieldombooks.CustomConstants
...
import com.breezefieldombooks.app.utils.Toaster
import com.breezefieldombooks.base.BaseResponse
import com.breezefieldombooks.base.presentation.BaseActivity
import com.breezefieldombooks.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldombooks.features.billing.api.AddBillingRepoProvider
import com.breezefieldombooks.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldombooks.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldombooks.features.document.model.DocumentAttachmentModel
...
import com.breezefieldombooks.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefieldombooks.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefieldombooks.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldombooks.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldombooks.features.orderhistory.model.*
...
import com.breezefieldombooks.features.quotation.model.AddQuotInputModel
import com.breezefieldombooks.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldombooks.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldombooks.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldombooks.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldombooks.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefieldombooks.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldombooks.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldombooks.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldombooks.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldombooks.mappackage.SendBrod
import com.breezefieldombooks.widgets.AppCustomTextView
import com.breezefieldombooks.MonitorService
import com.breezefieldombooks.MySingleton
import com.breezefieldombooks.app.AlarmReceiver
...
import com.breezefieldombooks.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldombooks.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldombooks.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldombooks.features.orderITC.SyncDeleteOpptL
import com.breezefieldombooks.features.orderITC.SyncEditOppt
import com.breezefieldombooks.features.orderITC.SyncOppt
import com.breezefieldombooks.features.orderITC.SyncOpptProductL
import com.breezefieldombooks.features.orderITC.SyncOrd
import com.breezefieldombooks.features.orderITC.SyncOrdProductL
import com.breezefieldombooks.features.performance.model.Gps_status_list
import com.breezefieldombooks.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldombooks.features.returnsOrder.ReturnProductList
import com.breezefieldombooks.features.returnsOrder.ReturnRequest
import com.breezefieldombooks.features.viewAllOrder.model.NewOrderSaveApiModel
import com.breezefieldombooks.features.viewAllOrder.model.NewStockSync
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezefieldombooks/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldombookslogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldombookslogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldombookslogsample/log.zip").path);
